...
Migration note: From analysis-service/src/orchestrator.py
"""
...
try:
    # Try relative import first (for when this module is run as part of the package)
    from ..meddic.agents import (
        ContextAgent,
        BuyerAgent,
        SellerAgent,
        SummaryAgent,
    ...
    # Fallback to original analysis-service path during migration
    from analysis_service.src.agents.agent1_context import ContextAgent
    from analysis_service.src.agents.agent2_buyer import BuyerAgent
    from analysis_service.src.agents.agent3_seller import SellerAgent
    from analysis_service.src.agents.agent4_summary import SummaryAgent
    from analysis_service.src.agents.agent6_crm_extractor import CRMExtractorAgent
    from analysis_service.src.agents.agent5_coach import CoachAgent, CoachAlert

logger = logging.getLogger(__name__)


# Models for orchestrator results
@dataclass
class AgentResult:
...
class AnalysisResult:
    ...
    manager_alert: Optional[Any] = None
...
class InsufficientDataError(Exception):
    """Error when there's not enough data to analyze."""
    pass
...
class MultiAgentOrchestrator:
    ...
    async def analyze_transcript(
        ...
        # =====================================================================
        # Phase 7: Agent 5 (Sales Coach) - Evaluate
        # =====================================================================
        logger.info("Phase 7: Agent 5 (Sales Coach) - Evaluate")
